...
earnings_00 <- read_csv(path %p% "DEC_00_SF3_PCT047_with_ann.csv", skip = 1)
earnings_05 <- acs_time(path %p% "B20017")
...
earnings_05_white <- acs_time(path %p% "B20017I")
...
earnings_05_black <- acs_time(path %p% "B20017B")
...
earnings_05_hispanic <- acs_time(path %p% "B20017I")
